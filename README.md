...
| LIFECYCLE_JOB_EXECUTION_CRON                   | Payment wallet lifecycle management job execution cron expression                                                                                          | string            |         |
| LIFECYCLE_JOB_EXECUTION_LIMIT                  | Payment wallet lifecycle management job query limit                                                                                                        | number            |         |
| LIFECYCLE_JOB_EXECUTION_EXCLUDED_STATUSES      | Payment wallet lifecycle management job excluded statuses                                                                                                  | list              |         |
| LIFECYCLE_JOB_EXECUTION_EXCLUDED_PERIOD_DAYS   | Payment wallet lifecycle management job excluded period in days                                                                                            | number            |         |
| LIFECYCLE_JOB_EXECUTION_ERROR_WALLET_TTL       | Payment wallet lifecycle management job TTL for wallets in error statuses                                                                                  | number            |         |
| LIFECYCLE_JOB_EXECUTION_DELETED_WALLET_TTL     | Payment wallet lifecycle management job TTL for wallets in deleted statuses                                                                                | number            |         |
| LIFECYCLE_JOB_EXECUTION_INSTANT_DELETE_TTL     | Payment wallet lifecycle management job TTL for instant deletions                                                                                          | number            |         |
