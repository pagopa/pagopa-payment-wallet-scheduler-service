...
| PAYMENT_WALLET_JOB_EXECUTION_LOCK_TTL_SECONDS                    | TTL in seconds for the distributed lock used by the wallet processing batch to ensure exclusive execution across multiple service instances                                                             | number            |         |
...
| LIFECYCLE_MANAGEMENT_JOB_EXECUTION_LOCK_TTL_SECONDS              | TTL in seconds for the distributed lock used by the lifecycle management batch to ensure exclusive execution across multiple service instances                                                          | number            |         |
