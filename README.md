...
| SCHEDULER_CDC_QUEUE_VISIBILITY_TIMEOUT_SECONDS                   | Visibility timeout in seconds for expired event                                                                                                            | long              |         |
...
| SCHEDULER_REDIS_JOB_LOCK_KEYSPACE                                | Prefix used for redis key name                                                                                                                             | string            |         |
| SCHEDULER_REDIS_JOB_LOCK_TTL_MS                                  | Fallbacks in milliseconds before now in case lock is not released                                                                                          | long              |         |
| SCHEDULER_REDIS_JOB_LOCK_WAIT_TIME_MS                            | Wait time in milliseconds for lock acquisition before giving up                                                                                            | long              |         |
| REDIS_HOST                                                       | Host of redis                                                                                                                                              | hostname (string) | test    | 
| REDIS_PORT                                                       | Port of redis                                                                                                                                              | number            | 6379    |
...
| LIFECYCLE_MANAGEMENT_JOB_EXECUTION_CRON                          | Cron expression for the lifecycle management job execution                                                                                                 | string            |         |
| LIFECYCLE_MANAGEMENT_JOB_EXECUTION_EXCLUDED_PERIOD_DAYS          | Exclusion period in days for the lifecycle management job                                                                                                  | number            |         |
| LIFECYCLE_MANAGEMENT_JOB_QUERY_EXCLUDED_STATUSES                 | List of wallet statuses to be excluded from the query                                                                                                      | list              |         |
| LIFECYCLE_MANAGEMENT_JOB_QUERY_SETTINGS_LOW_RATE                 | Minimum processing rate for lifecycle management queries                                                                                                   | number            |         |
| LIFECYCLE_MANAGEMENT_JOB_QUERY_SETTINGS_HIGH_RATE                | Maximum processing rate for lifecycle management queries during burst                                                                                      | number            |         |
...
| LIFECYCLE_MANAGEMENT_JOB_QUERY_SETTINGS_BURST_START_WINDOW       | Start time for the high-rate processing window (HH:mm)                                                                                                     | string            |         |
| LIFECYCLE_MANAGEMENT_JOB_QUERY_SETTINGS_BURST_END_WINDOW         | End time for the high-rate processing window (HH:mm)                                                                                                       | string            |         |
| LIFECYCLE_MANAGEMENT_JOB_TTL_ERROR_WALLET_TTL                    | Time to live for wallets in error status                                                                                                                   | number            |         |
| LIFECYCLE_MANAGEMENT_JOB_TTL_DELETED_WALLET_TTL                  | Standard time to live for lifecycle managed wallets                                                                                                        | number            |         |
